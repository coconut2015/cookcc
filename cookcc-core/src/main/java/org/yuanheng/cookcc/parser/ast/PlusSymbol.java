 ...
 * @author	Heng Yuan
 */
public class PlusSymbol extends InternalSymbol
{
	private final Symbol[] m_rhs;

	public PlusSymbol (Symbol symbol, Symbol[] rhs)
	{
		super (symbol);
		m_rhs = rhs;
	}
	...
	{
		SingleRule r1 = new SingleRule (getSymbol (), m_rhs, "", lineNumber, counter, null);
		rules.add (r1);
